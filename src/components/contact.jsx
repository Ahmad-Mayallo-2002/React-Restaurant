...
import ContactInfo from "../anotherComponent/contactInfor";
import Reviews from "../anotherComponent/Reviews";
function Contact() {
    return (
        <>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 d-flex justify-content-center">
                            <Form>
                                ...
                                <Form.Group className="row mb-3">
                                    <div className="col-md-6">
                                        <Form.Label htmlFor="data">Date</Form.Label>
                                        <Form.Control type="date" id="data" />
                                    </div>
                                    <div className="col-md-6">
                                        <Form.Label htmlFor="phone-number">Number of Guests</Form.Label>
                                        <Form.Control type="number" id="phone-number" />
                                    </div>
                                </Form.Group>
                                <Form.Group className="row mb-3">
